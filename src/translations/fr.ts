const frenchTranslations = {
 ...
 condition_factors: 'Facteurs de condition',
  ...
  v2_factor_fatigue: 'Fatigue de groupe',
  v2_factor_slope: 'Descente raide',
  v2_model_label: 'Modèle',
  v2_slope_aware: 'Ajustements de vitesse selon la pente appliqués',
  v2_fatigue_applied: 'Fatigue progressive de groupe appliquée',
  v2_section_analysis: 'Analyse des sections',
  v2_fatigue_short: 'fatigue',
  v2_model_basic: 'Estimation militaire de base (style FM)',
  v2_model_advanced: 'Estimation terrain avancée',
};
