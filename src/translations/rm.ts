const romanshTranslations = {
 ...
 condition_factors: 'Facturs da cundiziun',
  ...
  threat_factors: 'Facturs da nivel da smanatscha',
  ...
  v2_factor_breakdown: 'Detagl dals facturs',
  v2_base_time: 'Temp da basa',
  ...
  v2_factor_fatigue: 'Fatiga da gruppa',
  v2_factor_slope: 'Descendida storta',
  v2_model_label: 'Model',
  v2_slope_aware: 'Adattaments da spertadad tenor inclinaziun applitgads',
  v2_fatigue_applied: 'Fatiga progressiva da gruppa applitgada',
  v2_section_analysis: 'Analisa da las secziuns',
  v2_fatigue_short: 'fatiga',
  v2_model_basic: 'Stimaziun militara da basa (stil FM)',
  v2_model_advanced: 'Stimaziun da terrain avanzada',
};
